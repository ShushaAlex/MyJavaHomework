package de.telran.homework.eight;

public class Calc {

    public int getDaysCount(int accountBallance) {
        int days = 0;
        int newBallance = accountBallance;
        int i = accountBallance / 2;
        while (i > 0){
            if (newBallance % i == 0 && newBallance > i) {
                newBallance -= i;
                days += 1;
                i = newBallance / 2;
            } else {
